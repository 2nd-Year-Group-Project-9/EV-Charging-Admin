  ...
  return (
    <aside className="h-screen w-64 fixed left-0 top-0 bg-slate-100 dark:bg-slate-950 flex flex-col p-4 gap-2 z-50">
      ...
      <div className="mt-auto pt-6 border-t border-slate-200/50 dark:border-slate-800/50">
        <button className="w-full flex items-center justify-center gap-2 bg-gradient-to-br from-primary to-primary-container text-white py-3 rounded-full font-bold shadow-lg shadow-primary/20 hover:scale-95 transition-transform duration-200 mb-6">
          <span className="material-symbols-outlined">add</span>
          <span className="text-sm">Add New Station</span>
        </button>
        <div className="space-y-1">
          <a href="#" className="flex items-center gap-3 px-4 py-2 text-slate-600 dark:text-slate-400 text-xs font-semibold uppercase tracking-wide hover:text-teal-500">
            <span className="material-symbols-outlined">help</span>
            <span>Support</span>
          </a>
          <a href="#" className="flex items-center gap-3 px-4 py-2 text-slate-600 dark:text-slate-400 text-xs font-semibold uppercase tracking-wide hover:text-error">
